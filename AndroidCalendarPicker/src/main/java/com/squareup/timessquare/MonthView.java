...
public class MonthView extends LinearLayout {
    ...
    public void init(MonthDescriptor month, List<List<MonthCellDescriptor>> cells,
                     ...
                     int dayTextColorResId, int weekendTextColorResId) {
            ...
            if (i < numRows) {
                ...
                for (int c = 0; c < week.size(); c++) {
                    ...
                    if (!cellView.getDayOfMonthTextView().getText().equals(cellDate)) {
                        ...
                        if (isWeekend(cell.getDate())) {
                            cellView.getDayOfMonthTextView().setTextColor(ResourceCompat.getColorStateList(getContext(), weekendTextColorResId));
                        } else {
                            cellView.getDayOfMonthTextView().setTextColor(ResourceCompat.getColorStateList(getContext(), dayTextColorResId));
                        }
                    }
    ...
    private boolean isWeekend(Date date) {
        return getDayOfWeek(date) == 1 || getDayOfWeek(date) == 7;
    }
