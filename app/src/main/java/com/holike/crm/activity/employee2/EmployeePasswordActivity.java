...
/*员工信息 重置密码*/
public class EmployeePasswordActivity extends MyFragmentActivity<EmployeeResetPasswordPresenter, EmployeeResetPasswordView> implements EmployeeResetPasswordView {
    ...
    protected int setContentViewId() {
        return R.layout.activity_employee_passwordv2;
    }
    ...
    private void onResetPassword() {
        ...
        if (!TextUtils.equals(password, confirmPassword)) {
            ...
            String employeeId = getIntent().getExtras() == null ? "" : getIntent().getExtras().getString("userId", "");
