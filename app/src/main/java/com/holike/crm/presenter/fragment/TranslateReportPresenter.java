...
public class TranslateReportPresenter extends BasePresenter<TranslateReportView, TranslateReportModel> {
    ...
    public void getData(String cityCode, String startTime, String endTime, String type) {
        model.getData(cityCode == null ? "" : cityCode, startTime == null ? "" : String.valueOf(Long.parseLong(startTime)), endTime == null ? "" : String.valueOf(Long.parseLong(endTime) ), type == null ? "" : type, new TranslateReportModel.GetDataListener() {//时间先转化成秒
            @Override
