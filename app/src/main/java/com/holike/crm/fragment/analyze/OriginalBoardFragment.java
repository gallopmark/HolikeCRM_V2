...
public class OriginalBoardFragment extends MyFragment<OriginalBoardPresenter, OriginalBoardView> implements OriginalBoardView {
            ...
            public void onBindHolder(RecyclerHolder holder, OriginalBoardBean.PercentDataBean percentDataBean, int position) {
                ...
                tvArea.setOnClickListener(v -> {
                    if (percentDataBean.getIsClick() == 1) {
                        ...
                        startFragment(params, new OriginalBoardFragment());
                    }
                });
            }
        });
